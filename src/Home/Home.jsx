    ...
    return(
        ...
        <section className="container">
            <section className="row row-cols-1 row-cols-md-5 g-3">
                {
                    basedatos.map(function(peluquero){
                            return(
                                <div className="col">
                                    <div className="card h-100 shadow px-2">
                                        <h3>{peluquero.nombre}</h3>
                                        <h4>Especialidad: {peluquero.especialidad}</h4>
                                        <h4>Experiencia: {peluquero.experiencia}</h4>
                                        <h4>Correo: {peluquero.correo}</h4>
                                        <h4>Contacto: {peluquero.contacto}</h4>
